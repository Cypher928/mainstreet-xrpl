...
- **Tests:** `test-acquisition-terms.js`, `test-e2e-acquisition-abstraction.js`, `tools/verify-migration-025.js`, `tools/acquisition-terms-mutation.js`, `test-acquisition-resolver.js`, `tools/acquisition-resolver-mutation.js`.
