...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '.mso-panel{width:min(760px,100%);background:linear-gradient(180deg,var(--theme-surface),var(--theme-bg));border:1px solid rgba(255,255,255,.1);border-radius:18px;overflow:hidden;box-shadow:0 40px 100px -40px rgba(0,0,0,.9);}',
      ...
      '.mso-stat{background:var(--theme-bg);border:1px solid rgba(255,255,255,.07);border-radius:11px;padding:12px 16px;min-width:110px;}',
      ...
      '.mso-mock{background:var(--theme-bg);border:1px solid rgba(255,255,255,.07);border-radius:11px;overflow:hidden;}',
      ...
      '.mso-vchip{display:inline-block;background:var(--theme-bg);border:1px solid rgba(255,255,255,.09);border-radius:8px;padding:7px 12px;font-size:.8rem;color:#C6CEDA;margin:0 8px 8px 0;font-family:ui-monospace,"SF Mono",Menlo,monospace;}',
