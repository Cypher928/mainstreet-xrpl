...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      'background:radial-gradient(1200px 600px at 78% -8%,rgba(201,151,58,.12),transparent 60%),radial-gradient(900px 500px at 0% 108%,rgba(52,192,138,.07),transparent 55%),#07090c;}',
      ...
      '.mso-btn--primary{background:#C9973A;color:#07090c;}',
      ...
      '.mso-card{position:relative;text-align:left;background:linear-gradient(180deg,#191d24,#0a0d12);border:1px solid rgba(255,255,255,.07);border-radius:15px;padding:20px 18px 18px;cursor:pointer;overflow:hidden;transition:transform .2s,border-color .2s,box-shadow .2s;opacity:0;transform:translateY(14px);}',
      ...
      '.mso-panel{width:min(760px,100%);background:linear-gradient(180deg,#191d24,#07090c);border:1px solid rgba(255,255,255,.1);border-radius:18px;overflow:hidden;box-shadow:0 40px 100px -40px rgba(0,0,0,.9);}',
      ...
      '.mso-stat{background:#07090c;border:1px solid rgba(255,255,255,.07);border-radius:11px;padding:12px 16px;min-width:110px;}',
      ...
      '.mso-mock{background:#07090c;border:1px solid rgba(255,255,255,.07);border-radius:11px;overflow:hidden;}',
      ...
      '.mso-vchip{display:inline-block;background:#07090c;border:1px solid rgba(255,255,255,.09);border-radius:8px;padding:7px 12px;font-size:.8rem;color:#C6CEDA;margin:0 8px 8px 0;font-family:ui-monospace,"SF Mono",Menlo,monospace;}',
      '.mso-evd{background:#07090c;border-left:2px solid var(--a);border-radius:0 10px 10px 0;padding:13px 16px;}',
      ...
      '.mso-ring span{width:58px;height:58px;border-radius:50%;background:#07090c;display:grid;place-items:center;font-weight:800;font-size:1.05rem;}',
      ...
      '.mso-mini--primary{background:#C9973A;color:#07090c;border-color:#C9973A;}',
      '.mso-mini--primary:hover{filter:brightness(1.08);color:#07090c;}',
      '.mso-mini--accent{background:color-mix(in srgb,var(--a) 90%,#000);color:#07090c;border-color:var(--a);}',
