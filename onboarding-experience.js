...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      'font-family:-apple-system,system-ui,"Segoe UI",Roboto,Helvetica,Arial,sans-serif;color:var(--c-f3efe6);',
      'background:radial-gradient(1200px 600px at 78% -8%,rgba(201,151,58,.12),transparent 60%),radial-gradient(900px 500px at 0% 108%,rgba(52,192,138,.07),transparent 55%),var(--theme-bg);}',
      ...
      '.mso-brand{font-family:ui-monospace,"SF Mono",Menlo,Consolas,monospace;letter-spacing:.2em;text-transform:uppercase;font-size:.72rem;color:var(--text-3);}',
      '.mso-brand b{color:var(--c-f3efe6);}',
      '.mso-skip{background:none;border:none;color:var(--text-3);font-size:.82rem;cursor:pointer;font-family:inherit;padding:8px 4px;transition:color .2s;}',
      '.mso-skip:hover{color:var(--c-c9973a);}',
      '.mso-hero{max-width:760px;}',
      '.mso-eyebrow{font-family:ui-monospace,"SF Mono",Menlo,monospace;font-size:.74rem;letter-spacing:.22em;text-transform:uppercase;color:var(--c-c9973a);display:flex;align-items:center;gap:12px;margin:0 0 20px;}',
      ...
      '.mso-sub{font-size:clamp(1rem,1.7vw,1.2rem);line-height:1.55;color:var(--text-2);margin:20px 0 0;max-width:62ch;}',
      '.mso-who{font-family:ui-monospace,"SF Mono",Menlo,monospace;font-size:.8rem;color:var(--text-3);margin:16px 0 0;letter-spacing:.02em;}',
      ...
      '.mso-btn--primary{background:#C9973A;color:var(--theme-on-accent);}',
      '.mso-btn--primary:hover{filter:brightness(1.08);}',
      '.mso-btn--ghost{background:rgba(var(--line-rgb), .03);color:var(--c-f3efe6);border-color:rgba(var(--line-rgb), .14);}',
      '.mso-btn--ghost:hover{border-color:#C9973A;color:var(--c-c9973a);}',
      ...
      '.mso-card{position:relative;text-align:left;background:linear-gradient(180deg,var(--theme-surface),var(--theme-panel));border:1px solid rgba(var(--line-rgb), .07);border-radius:15px;padding:20px 18px 18px;cursor:pointer;overflow:hidden;transition:transform .2s,border-color .2s,box-shadow .2s;opacity:0;transform:translateY(14px);}',
      ...
      '.mso-card p{margin:6px 0 0;font-size:.86rem;line-height:1.45;color:var(--text-3);}',
      ...
      '.mso-panel{width:min(760px,100%);background:linear-gradient(180deg,var(--theme-surface),var(--theme-bg));border:1px solid rgba(var(--line-rgb), .1);border-radius:18px;overflow:hidden;box-shadow:0 40px 100px -40px rgba(0,0,0,.9);}',
      '.mso-phead{display:flex;align-items:center;gap:13px;padding:18px 22px;border-bottom:1px solid rgba(var(--line-rgb), .06);}',
      '.mso-phead .mso-ic{margin:0;width:38px;height:38px;}',
      '.mso-phead-t{font-weight:700;font-size:1.02rem;}',
      '.mso-phead-tag{font-size:.78rem;color:var(--text-3);margin-top:1px;}',
      '.mso-pclose{margin-left:auto;background:none;border:none;color:var(--text-3);font-size:1.3rem;line-height:1;cursor:pointer;padding:4px 8px;border-radius:8px;}',
      '.mso-pclose:hover{color:var(--c-f3efe6);background:rgba(var(--line-rgb), .05);}',
      '.mso-pbar{height:3px;background:rgba(var(--line-rgb), .07);}',
      ...
      '.mso-step p{margin:0;font-size:.98rem;line-height:1.55;color:var(--text-2);max-width:60ch;}',
      '.mso-visual{margin-top:18px;}',
      '.mso-statrow{display:flex;gap:12px;flex-wrap:wrap;}',
      '.mso-stat{background:var(--theme-bg);border:1px solid rgba(var(--line-rgb), .07);border-radius:11px;padding:12px 16px;min-width:110px;}',
      '.mso-stat-v{display:block;font-size:1.3rem;font-weight:800;letter-spacing:-.01em;}',
      '.mso-stat-l{display:block;font-size:.68rem;text-transform:uppercase;letter-spacing:.1em;color:var(--text-3);margin-top:2px;}',
      '.mso-mock{background:var(--theme-bg);border:1px solid rgba(var(--line-rgb), .07);border-radius:11px;overflow:hidden;}',
      '.mso-mrow{display:flex;justify-content:space-between;align-items:center;padding:10px 15px;font-size:.9rem;border-bottom:1px solid rgba(var(--line-rgb), .05);}',
      '.mso-mrow:last-child{border-bottom:none;}.mso-mrow b{font-variant-numeric:tabular-nums;}',
      '.mso-mrow em{color:var(--c-c9973a);font-style:normal;font-size:.78rem;}',
      '.mso-mrow--cap b{color:var(--c-c9973a);}.mso-mrow--hi{background:rgba(201,151,58,.06);}.mso-mrow--hi b{color:var(--c-4ade80);}',
      '.mso-vchip{display:inline-block;background:var(--theme-bg);border:1px solid rgba(var(--line-rgb), .09);border-radius:8px;padding:7px 12px;font-size:.8rem;color:var(--text-2);margin:0 8px 8px 0;font-family:ui-monospace,"SF Mono",Menlo,monospace;}',
      '.mso-evd{background:var(--theme-bg);border-left:2px solid var(--a);border-radius:0 10px 10px 0;padding:13px 16px;}',
      '.mso-evd-q{display:block;font-style:italic;color:var(--c-f3efe6);line-height:1.5;font-size:.92rem;}',
      '.mso-evd-src{display:block;margin-top:7px;font-family:ui-monospace,"SF Mono",Menlo,monospace;font-size:.72rem;color:var(--text-3);}',
      '.mso-verdict{display:inline-block;background:rgba(201,151,58,.1);border:1px solid rgba(201,151,58,.35);color:var(--c-e4b75c);border-radius:9px;padding:10px 15px;font-size:.9rem;font-weight:600;}',
      '.mso-conf{display:inline-block;border-radius:7px;padding:5px 12px;font-size:.75rem;font-weight:700;margin-right:8px;}',
      '.mso-conf--hi{background:rgba(52,192,138,.14);color:var(--c-4ade80);}.mso-conf--mid{background:rgba(201,151,58,.14);color:var(--c-e4b75c);}',
      '.mso-ring{--pct:72;width:76px;height:76px;border-radius:50%;display:inline-grid;place-items:center;background:conic-gradient(var(--a) calc(var(--pct)*1%),rgba(var(--line-rgb), .08) 0);vertical-align:middle;}',
      '.mso-ring span{width:58px;height:58px;border-radius:50%;background:var(--theme-bg);display:grid;place-items:center;font-weight:800;font-size:1.05rem;}',
      '.mso-ring-l{margin-left:12px;font-size:.85rem;color:var(--text-3);}',
      '.mso-pfoot{display:flex;align-items:center;gap:12px;padding:16px 26px 22px;flex-wrap:wrap;}',
      '.mso-dots{display:flex;gap:7px;}',
      '.mso-dot{width:7px;height:7px;border-radius:50%;background:rgba(var(--line-rgb), .18);transition:background .2s,transform .2s;}',
      ...
      '.mso-link{background:none;border:none;color:var(--text-3);font:inherit;font-size:.85rem;cursor:pointer;padding:8px;}',
      '.mso-link:hover{color:var(--c-c9973a);}',
      '.mso-mini{font:inherit;font-size:.86rem;font-weight:700;border-radius:9px;padding:9px 15px;cursor:pointer;border:1px solid rgba(var(--line-rgb), .14);background:rgba(var(--line-rgb), .03);color:var(--c-f3efe6);transition:border-color .2s,color .2s,background .2s;}',
      '.mso-mini:hover{border-color:var(--a);color:var(--a);}',
      '.mso-mini--primary{background:#C9973A;color:var(--theme-on-accent);border-color:#C9973A;}',
      '.mso-mini--primary:hover{filter:brightness(1.08);color:var(--theme-on-accent);}',
      '.mso-mini--accent{background:color-mix(in srgb,var(--a) 90%,#000);color:var(--theme-on-accent);border-color:var(--a);}',
